...
TOKEN = '8047907032:AAHv1U0-s0bK5kI325DsAQ3-ii23-_HAINE'  # Replace with your actual bot token
...
def bgmi_command(message):
    ...
    try:
        ...
        logging.info(f"Attack started by {user_name}: ./paid {target_ip} {target_port} {default_duration}")
